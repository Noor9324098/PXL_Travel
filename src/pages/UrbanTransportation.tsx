...
import { Bus, Calendar, Clock, Ticket, Users } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { busTrips, type TravelOption } from "@/lib/travelOptions";

const UrbanTransportation = () => {
				...
				<div className="container mx-auto px-6">
					<div className="mb-8 animate-fade-in">
						<div className="flex items-center gap-3 mb-4">
							...
							<Badge className="bg-primary/10 text-primary border-primary/20">Bus Only</Badge>
						</div>
						<h1 className="font-display text-4xl font-bold mb-2">Buses and Urban Transportation</h1>
						<p className="text-muted-foreground max-w-2xl">
							Bus connections for campus, city center, and neighborhood travel. Every route here is bus-only and booked directly.
						</p>
					</div>
									...
									<div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
										<div className="space-y-3">
											<div className="flex flex-wrap items-center gap-3">
												<Badge className="bg-[#DB7B21] text-white border-0">bus route</Badge>
...
export default UrbanTransportation;
